...
import {
  ...
  FeedListItemHeading,
  FeedListItemLink,
  FeedListItemMainImage,
  FeedListItemTextStyle,
  FeedListItemGridContainer,
  FeedListItemTextContainerStyle,
} from "./styles";
...
export const FeedListItem = (item: itemType) => {
  ...
  return (
    <li css={css(FeedListItemStyle)}>
      <article>
        <header>
          <time css={css(FeedListItemTextStyle)} dateTime="">
            {pubDate}
          </time>
          <a
            css={css(FeedListItemLink)}
            href={link}
            target="_blank"
        ...
        {enclosure ? (
          <div css={css(FeedListItemGridContainer)}>
            <img src={enclosure} alt={title} css={css(FeedListItemMainImage)} />
            <div css={css(FeedListItemTextContainerStyle)}>
              <div
                css={css(FeedListItemTextStyle)}
